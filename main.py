...
async def on_message(ctx):
  ...
  if "mario" in ctx.content.lower():
    inputBowser=[
  "https://i.pinimg.com/originals/6b/06/ef/6b06efe5f20cc72a4c637d74f74286ec.jpg","https://static.tvtropes.org/pmwiki/pub/images/bowser2.png","https://www.pride.com/sites/default/files/gay-bowser-line-removed-super-mario-3d-all-stars-nintendo-switch.jpg","https://static.wikia.nocookie.net/characterprofile/images/e/ec/Bowser_-_New_Super_Mario_Bros_2.png/revision/latest/scale-to-width-down/340?cb=20160104174133","https://images-na.ssl-images-amazon.com/images/I/6109-LVtLML._AC_SY355_.jpg","https://i5.walmartimages.com/asr/4472509f-9c37-4b43-9acf-f1c3d8bbff08_1.67709de39df9fa369a5f3a157aea4b02.jpeg","https://static.wikia.nocookie.net/fantendo/images/7/7d/Dr._Bowser_-_Dr._Mario_World.png/revision/latest?cb=20190622032512","https://images-na.ssl-images-amazon.com/images/I/81N-jrD1t6L._AC_SL1500_.jpg","https://www.videogameschronicle.com/files/2020/04/Lego-Bowser.jpg"]
    outBowser=(str(random.choice(inputBowser)))
    embed=discord.Embed(title="Mario?!", url="", description="How dare you disturb my family vacation!", color=discord.Color.red())
    embed.set_author(name="Bowser", url="", icon_url=outBowser)
    embed.set_thumbnail(url=outBowser)
...
try:
  ...
  print(f"\n\nUh oh! Something happened!\n\nMake sure your assetFiles/config.py is formatted properly and the token is correct!\n\n")